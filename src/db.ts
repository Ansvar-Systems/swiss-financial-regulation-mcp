/**
 * SQLite database access layer for the FINMA MCP server.
 *
 * Schema mirrors the FINMA regulatory structure:
 *   - sourcebooks        — top-level FINMA publication categories (Rundschreiben, Verordnungen, etc.)
 *   - provisions         — individual articles, circulars, and regulatory requirements
 *   - enforcement_actions — FINMA enforcement decisions and proceedings
 *
...
export function getProvision(
  ...
  // Fuzzy fallback: partial match on reference
  return (
    (db
      .prepare(
